  ...
  return (
    <div className="flex-none lg:max-w-2xl xl:max-w-4xl">
      <div className="space-y-6">
              ...
              <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div className="flex items-center justify-between md:order-3 md:justify-end">
                  <div className="flex items-center">
                    <button
                      onClick={() =>
                        handleUpdateQty({ id: cartProduct.product.id, qty: -1 })
                      }
                      type="button"
                      id="decrement-button"
                  ...
                  <div className="text-end md:order-4 md:w-32">
                    <p className="text-base font-bold text-gray-900">
                      ${(cartProduct.product.price * cartProduct.qty).toFixed(2)}
                    </p>
                  </div>
                </div>
        ...
        [1,2,3].map((item) => {
          return <Skeleton key={item} allowHorizontal={true} allowImage={true} />
        })
      }
      </div>
    </div>
